...
export default function SkillSection() {
  const MySkils = [
    {
      title: "React",
      icon: <FaReact className="skill-icon text-3xl  text-blue-500" />,
      rate: 4,
      category: "Framework",
    ...
    {
      title: "NextJs",
      icon: <RiNextjsFill className="skill-icon text-3xl  text-black" />,
      rate: 4,
      category: "Framework",
    ...
    {
      title: "TypeScript",
      icon: <SiTypescript className="skill-icon text-3xl text-blue-500" />,
      rate: 5,
      category: "Language",
  ...
  return (
    ...
    <div id='skill' className="skill mt-5 mb-5 px-16 flex flex-col justify-center items-center ">

      <div className="text-5xl text-white font2">MY SKILLS</div>
      <div className="flex justify-around flex-wrap">
        {
          MySkils.map((skill: any, i: number) => {
            return (
              <div key={i} className="parent mt-2 cursor-pointer">
                <div className="card">
                  <div className="logo">
                  ...
                  <div className="content">
                    ...
                    <span className="text">{skill.description}</span>
                  </div>
